...
**Testing Practice** is a JavaScript project at microverse

## 🛠 Built With <a name="built-with">Java Script, Jest</a>
...
- tests a single function which returns length of a string
...
git clone https://github.com/kalbek/Testing-Practice
...
### Run tests
- test for this project is written using Jest framework
